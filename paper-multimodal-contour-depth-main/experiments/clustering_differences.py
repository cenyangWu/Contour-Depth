...
from src.clustering.cdclust import kmeans_cluster_eid, multiscale_kmeans_cluster_inclusion_matrix,multiscale_kmeans_cluster_eid, kmeans_cluster_inclusion_matrix
...
if __name__ == "__main__":
    ...
    pred_labs3 = multiscale_kmeans_cluster_inclusion_matrix(masks, num_clusters=K, depth="id", num_attempts=5, max_num_iterations=5, seed=SEED_CLUSTER)
