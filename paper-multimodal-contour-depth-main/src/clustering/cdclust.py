...
def multiscale_cluster_inclusion_matrix(masks, num_clusters, depth="ecbd", metric="depth", num_attempts=5, size_window=60,max_num_iterations=10, seed=42):
...
def largest_depth(masks,depth="eid", metric="depth"):
    ...
    for i in range(num_masks):
        ...
        if depth_in_cluster > best_depth:
            best_depth = depth_in_cluster
            best_id = i
    print(best_id)
    print(best_depth)
